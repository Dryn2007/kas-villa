<x-app-layout>
    <div class="max-w-md mx-auto bg-gray-50 min-h-screen pb-12 font-sans pt-6 px-5">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-extrabold text-gray-800">Panel Admin 👑</h1>
                    ...
                    <div class="flex gap-2 ml-2">
                        <form action="{{ route('admin.reject', $pending->id) }}" method="POST" class="w-1/3">
                            ...
                            <button type="submit" onclick="return confirm('Yakin ingin menolak tagihan ini?')"
                                class="w-full bg-red-50 hover:bg-red-100 text-red-600 font-bold py-3 rounded-xl transition-colors border border-red-100 text-sm">
                                Tolak ❌
                            </button>
                        </form>
